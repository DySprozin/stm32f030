...
int work = 0;
 ...
 void main(void) {
  ...
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->MODER &= (~((uint32_t)0x00000003) |
                   ~((uint32_t)0x0000000C) |
                   ~((uint32_t)0x00000030) |
                   ~((uint32_t)0x000000C0) |
                   ~((uint32_t)0x00000300) |
  ...
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->PUPDR |= ((uint32_t)0x00000001) | 
                 ((uint32_t)0x00000004) |
                 ((uint32_t)0x00000010) |
                 ((uint32_t)0x00000040) |
                 ((uint32_t)0x00000100) |
 ...
 flash_enable();
  ...
  if ( (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000001)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000002)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000004)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000008)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000010)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000020)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000040)) &&
      (((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000080)) ) work = 1;
  
  
  if (work == 1) {
    for (int i=0; i<10; i++) {
     flash_erase(0x8001400+1024*i);
    }
    flash_write_start();
  }
  ...
  if (tim_ch++ > 3600000 || work == 1) {
    tim_ch=0;
    flash_write_int32(0x8001400, 0x12345678);
    flash_write_int32(0x8001400+4, 0x87654321);

  }
  
  while(1) {
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000001))) { flag[0] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000001)) && flag[0] == 1) { rots[0]++; flag[0] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000002))) { flag[1] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000002)) && flag[1] == 1) { rots[1]++; flag[1] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000004))) { flag[2] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000004)) && flag[2] == 1) { rots[2]++; flag[2] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000008))) { flag[3] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000008)) && flag[3] == 1) { rots[3]++; flag[3] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000010))) { flag[4] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000010)) && flag[4] == 1) { rots[4]++; flag[4] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000020))) { flag[5] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000020)) && flag[5] == 1) { rots[5]++; flag[5] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000040))) { flag[6] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000040)) && flag[6] == 1) { rots[6]++; flag[6] = 0; }
   if ((((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000080))) { flag[7] = 1; } else if (!(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000000))->IDR & ((uint32_t)0x00000080)) && flag[7] == 1) { rots[7]++; flag[7] = 0; }
  }
...
void SysTick_Handler(void) {
  if (tim_ch++ > 3600) {
    ...
    tmp = 0x8001400+1024*0+nbytes; flash_write_int32(tmp, rots[0]); rots[0] = 0;
    tmp = 0x8001400+1024*1+nbytes; flash_write_int32(tmp, rots[1]); rots[1] = 0;
    tmp = 0x8001400+1024*2+nbytes; flash_write_int32(tmp, rots[2]); rots[2] = 0;
    tmp = 0x8001400+1024*3+nbytes; flash_write_int32(tmp, rots[3]); rots[3] = 0;
    tmp = 0x8001400+1024*4+nbytes; flash_write_int32(tmp, rots[4]); rots[4] = 0;
    tmp = 0x8001400+1024*5+nbytes; flash_write_int32(tmp, rots[5]); rots[5] = 0;
    tmp = 0x8001400+1024*6+nbytes; flash_write_int32(tmp, rots[6]); rots[6] = 0;
    tmp = 0x8001400+1024*7+nbytes; flash_write_int32(tmp, rots[7]); rots[7] = 0;
